  ...
  return (
    <Layout>
        ...
        <Menu theme="dark" mode="horizontal" selectedKeys={[activeSection]} style={{ backgroundColor: '#3A0268' }}>
          ...
          <Menu.Item 
            ...
            style={{
              color: '#fff', 
              fontWeight: 'bold', 
              backgroundColor: '#d850e1', // Purple background for standout 
      ...
      <Content style={{
        ...
        backgroundImage: "url('')", // Set GIF as background image
        backgroundRepeat: 'repeat', // Makes the background repeat
        backgroundSize: 'cover', // Ensures the image covers the area
        backgroundPosition: 'center', // Centers the image
        position: 'relative', // To ensure overlay elements are positioned correctly
      }}>
                ...
                <Card title="Welcome" hoverable>
                  <FloatingText className="text-animation">
                    <Row gutter={[16, 16]}>
                      <Col span={24}>
                        <Title level={3}>
                          <UserOutlined style={{ marginRight: '8px' }} /> Welcome to My Portfolio
                        </Title>
                        <Paragraph>
                          A glimpse into my journey, my work, and my passion. I'm Christian Graber, a Computer Science student with a passion for software development and technology. 
                          I'm excited to share my projects, skills, and experiences with you. Feel free to explore and reach out if you have any questions or opportunities to discuss.
                        </Paragraph>
                      </Col>
                    </Row>
                  </FloatingText>
                ...
                <Card title="Contact" hoverable>
                  ...
                  <ul style={{ listStyleType: 'none', paddingLeft: 0 }}>
                    <li>
                      ...
                      <a href="mailto:your.email@example.com">grabercn@mail.uc.edu</a>
                    </li>
                    <li>
                      <LinkedinOutlined style={{ marginRight: '8px' }} />
                      <a href="https://www.linkedin.com/in/christian-graber">christian-graber</a>
                    </li>
                  </ul>
                  </FloatingText>
                </Card>
